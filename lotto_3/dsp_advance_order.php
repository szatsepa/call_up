...
<!--                        <input type="text" maxlength="2" size="2" name="day" class="step1" value=""/>-->
                        -
<!--                        <input type="text" maxlength="2" size="2" name="mon" class="step1" value=""/>-->
                      ...
                      <?php }
                        ...
                        -
<!--                        <input type="text" maxlength="4" size="4" name="year" class="step1" value=""/>-->
                      ...
                      <?php }
                        ...
                        &nbsp;дд-мм-гггг&nbsp;&nbsp;
<!--                        <input type="text" maxlength="2" size="2" name="hh" class="step1" value=""/>-->
...
<!--                        <input type="text" maxlength="2" size="2" name="mm" class="step1" value=""/>-->
