...
if(isset ($_SESSION[user])){
        ...
        $result = mysql_query("SELECT price_id FROM cart WHERE $field = $user_id GROUP BY price_id");

}  else {
    
    $secret_key = quote_smart($attributes[cod]);

    $result = mysql_query("SELECT price_id FROM cart WHERE cod = $secret_key GROUP BY price_id");
}
