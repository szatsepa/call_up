...
if ($zakaz) {
      ...
      $name = $_SESSION[user]->data[name];
            ...
            $message ="Здравствуйте $surname $name! Ваш заказ принят в обработку. С вами свяжется оператор .\n C уважением. Администрация. ";              
...
<form action="index.php?act=look<?php echo $address;?>" method="post">
    <script language="javascript">
    document.write ('<input type="hidden" name="cod" value="<?php echo $attributes[cod];?>"/><input type="hidden" name="order" value="<?php echo $zakaz;?>"/><input type="hidden" name="stid" value="<?php echo $st_id;?>"/></form>');
