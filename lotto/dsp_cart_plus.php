                                 ...
                                 if(!$list_volume[$posart + 1][str_code1])$dis = "disabled";
                                  ?>
                                    ...
                                    <form action="index.php?act=change_volume" method="post">
                                        <p align="center"><input type="image" src="<?php echo "http://$_SESSION[domen]";?>/images/storefront/btn_up.gif" alt="Добвить" name="submit" value="val" style="vertical-align: middle" <?php echo $dis;?>/></p>
