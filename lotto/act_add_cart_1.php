...
<form action="index.php?act=look" method="post">
    ...
    document.write ('<input name="cod" type="hidden" value="<?php echo $attributes[cod];?>"/><input name="type" type="hidden" value="<?php echo $attributes[type];?>"/><input name="stid" type="hidden" value="<?php echo $attributes[stid];?>"/><input name="affected" type="hidden" value="<?php echo $affected;?>"/></form>');
...
<?php
 ...
 <form action="index.php?act=order" method="post">
    <script language="javascript">
    document.write ('<input name="type" type="hidden" value="<?php echo $attributes[type];?>"/><input name="cod" type="hidden" value="<?php echo $attributes[cod];?>"><input name="stid" type="hidden" value="<?php echo $attributes[stid];?>"><input name="type" type="hidden" value="0"><input name="up" type="hidden" value="1"></form>');
    document.forms[0].submit();
    </script>   
    <?php
}else{
