...
<script type="text/javascript">  
    var user = {id:<?php echo $_SESSION[id];?>}; 
    
    var page = <?php echo $attributes[page];?>;
...
<?php            }else if($artikul_i){
           ...
           ?> 
				...
				<div id = "img_vtrn">
                                    ...
                                    <input class='my_button' id='<?php echo $ind;?>' type="image" src="main/act_prewiew.php?src=http://call-up.ru/images/goods/<?php echo $image;?>&amp;width=60&amp;height=60"/>
